...
**При неправильно введенных бинарных данных, в выходной файл будет содержать предупреждени!**\
**Не забывайте про префикс на входных данных**

* '0x' - шестнадцатиричное система счисления
* '0b' - двочиная система счиления
* '0' перед числом - восьмиричная система счисления
* 'число' - десятиричная система счисления
